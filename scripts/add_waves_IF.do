...
add wave -color yellow  -label IF_ir_out            -radix HEX sim:/tb_dlx/UUT/core_inst/IF_stage/FETCH_ir_out
add wave -color yellow  -label IF_pc                -radix HEX sim:/tb_dlx/UUT/core_inst/IF_stage/FETCH_pc
add wave -color yellow  -label IF_npc               -radix HEX sim:/tb_dlx/UUT/core_inst/IF_stage/FETCH_npc
add wave -color yellow  -label IF_btb_prediction_out           sim:/tb_dlx/UUT/core_inst/IF_stage/FETCH_btb_prediction_out
add wave -color yellow  -label IF_btb_target_out    -radix HEX sim:/tb_dlx/UUT/core_inst/IF_stage/FETCH_btb_target_out

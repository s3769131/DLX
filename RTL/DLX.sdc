...
set_clock_uncertainty [format %.4f [expr $clockPeriod*0.01]]  $clockName
...
#set_min_delay 0.1 -through [all_registers] -from [all_inputs] -to [all_outputs] ;## THIS LINE WILL CRASH DC_SHELL!!!!!!!!!
set_max_delay -from [all_inputs] -to [all_outputs] $clockPeriod
#
#;# Set-up IOs
...
set_input_delay 0 -clock $clockName $clockName
#
